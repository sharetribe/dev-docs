...
{/* prettier-ignore */}
<Tabs items={['Claude Code', 'Claude Desktop', 'ChatGPT Desktop', 'Cursor', 'VS Code', 'Antigravity', 'Other']}>
  <Tabs.Tab>
...
Add the following snippet into your `/.gemini/config/mcp_config.json`
file:

```shell filename="./.gemini/config/mcp_config.json"
{
  "mcpServers": {
    "sharetribe-docs": {
      "command": "npx",
      "args": ["-y", "mcp-remote", "https://sharetribe.mcp.kapa.ai"]
    }
  }
}
...
Restart Antigravity and authenticate when prompted.
