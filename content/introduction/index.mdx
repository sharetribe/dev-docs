...
Welcome to our comprehensive demonstration of Nextra's powerful built-in
components! This page showcases all the amazing features available for
creating stunning documentation.
...
<Tabs items={['yarn', 'npm']}>
  <Tabs.Tab>```bash yarn global add flex-cli ```</Tabs.Tab>
  <Tabs.Tab>```bash npm add flex-cli ```</Tabs.Tab>
</Tabs>
