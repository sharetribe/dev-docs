...
<Table>
  ...
  <tbody>
    ...
    <Table.Tr>
      <Table.Td>**Secure runtime environment needed**</Table.Td>
...
[later in this article](initializing-the-SDK-with-a-trusted-user-access-token).
...
<Callout type="info">
  Certain requests will a secure runtime environment. An easy way to do
...
require a secure runtime environment (e.g. a server) and this can only
be done when initializing the SDK with both the Client ID and Client
Secret.
...
- The request is made from a secure runtime environment
...
<Callout type="info">
  ...
  non-privileged transitions, simply [logging
