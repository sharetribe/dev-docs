...
<Table>
  ...
  <tbody>
    ...
    <Table.Tr>
      ...
      <Table.Td>When trusted SDK is used</Table.Td>
      <Table.Td>When trusted SDK is used</Table.Td>
    </Table.Tr>
  </tbody>
</Table>
...
- A token exchange happens to obtain a trused user access token
...
<Callout type="info">
  ...
  requests are made on an small Node server included in the Template.
</Callout>
...
For the complete documentation on Sharetribe's SDKs, visit our Github
documentation for the
[Standard SDK](https://sharetribe.github.io/flex-sdk-js/index.html) and
the
[Integration SDK](https://sharetribe.github.io/flex-integration-sdk-js/).
There, you'll find
...
- How to use the browser or the
  [API Playground](https://sharetribe.GitHub.io/flex-sdk-js/try-it-in-the-playground.html)
  (only available for the standard SDK) for easy testing

<Callout type="info">
  Certain requests will require a secure environment setup. An easy way
  to do this is to run a small server from which to make these types of
  requests.
</Callout>
