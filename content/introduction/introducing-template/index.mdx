...
<iframe
  width="560"
  height="315"
  src="https://www.youtube-nocookie.com/embed/2gOM61b8LJM"
...
[here](/concepts/listings/listings-overview/).
...
Read more about
[inventory management in Sharetribe](/concepts/availability/inventory-management/).
...
[configure your search settings](/template/configuration/variables/).
...
[configure extended data in the Sharetribe Web Template](/template/configuration/variables/).
...
customers can create listings and providers can submit offers.

Once the customer and provider have agreed on a price for the
transaction, the customer then proceeds to make a payment. The default
negotiation process does not include calendar bookings or stock.

The Sharetribe Web Template also supports a regular marketplace flow
with price negotiation. This means that a provider creates the listing
and a customer requests a quote from the provider.
...
Learn more about
[how payments work in Sharetribe](/concepts/payments/payments-overview/).
...
[user accounts and authentication work in Sharetribe](/concepts/users-and-authentication/users-and-authentication-in-sharetribe/).
...
Learn more about
[handing seller onboarding on your marketplace](/concepts/payments/providers-and-customers-on-stripe-platform/).
...
Learn more about
[how email notifications work in Sharetribe](/concepts/messages-notifications/email-notifications/).
...
Learn more about
[how content works in Sharetribe](/concepts/content-management/content-management-in-sharetribe/).
