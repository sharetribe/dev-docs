...
sidebarTitle: Install the Sharetribe Web Template
description:
...
<details> 
<summary>Check how the directory structure should look like</summary>
...
See the [template environment variables](/template/configuration/template-env/) for
...
[tutorial](/tutorial/) to learn how to customize the
