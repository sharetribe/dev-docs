...
description: This tutorial is the place to start your journey building custom
...
[Integration API application](/concepts/development/applications/) in Sharetribe
Console.
