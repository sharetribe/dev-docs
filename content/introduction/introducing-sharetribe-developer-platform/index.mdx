...
sidebarTitle: Sharetribe Developer Platform
description:
...
[The Sharetribe JavaScript SDK](/concepts/api-sdk/js-sdk/) is a small
...
easy to use correct data types with the API. Using the Sharetribe JS SDK
is not required, but if you are working with JavaScript, we strongly
