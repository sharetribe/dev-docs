...
sidebarTitle: Implement user deletion
description: This article guides you in implementing a feature where a user can delete their own account through the Sharetribe Web Template Account settings section.
---
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="containers" defaultOpen>
      <FileTree.Folder name="DeleteAccountPage" defaultOpen>
        <FileTree.File name="DeleteAccountPage.js" />
        <FileTree.File name="DeleteAccountPage.duck.js" />
        <FileTree.File name="DeleteAccountPage.module.css" />
      </FileTree.Folder>
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>

- [DeleteAccountPage.js](/resources/cookbook-assets/DeleteAccountPage.js)
- [DeleteAccountPage.duck.js](/resources/cookbook-assets/DeleteAccountPage.duck.js)
- [DeleteAccountPage.module.css](/resources/cookbook-assets/DeleteAccountPage.module.css)
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="containers" defaultOpen>
      <FileTree.File name="reducers.js" />
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
[Sharetribe Console Marketplace texts editor](/concepts/content-management/marketplace-texts/).
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="containers" defaultOpen>
      <FileTree.Folder name="DeleteAccountPage" defaultOpen>
        <FileTree.Folder name="DeleteAccountForm" defaultOpen>
          <FileTree.File name="DeleteAccountForm.js" />
          <FileTree.File name="DeleteAccountForm.module.css" />
        </FileTree.Folder>
      </FileTree.Folder>
    </FileTree.Folder>
  </FileTree.Folder>
...
- [DeleteAccountForm.js](/resources/cookbook-assets/DeleteAccountForm.js)
- [DeleteAccountForm.module.css](/resources/cookbook-assets/DeleteAccountForm.module.css)
...
<details>
  <summary>Wrap DeleteAccountForm in a modal</summary>
...
<FileTree>
  <FileTree.Folder name="server" defaultOpen>
    <FileTree.Folder name="api" defaultOpen>
      <FileTree.File name="delete-account.js" />
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>

- [delete-account.js](/resources/cookbook-assets/delete-account.js)
...
<details>
  <summary>Check pending payouts</summary>
...
```js
  ...
  .then(resp => {
   // In the default-booking and default-purchase processes,
   // payouts are created on "transition/complete". We want to
   // determine the transactions where this transition has
   // been created less than 7 days ago.
   const pendingPayouts = resp.data.data.filter(tx =>{
       // For the transactions where the user is the provider,
       // check the transitions
       // to determine whether "transition/complete" was created
...
<FileTree>
  <FileTree.Folder name="server" defaultOpen>
    <FileTree.File name="apiRouter.js" />
  </FileTree.Folder>
</FileTree>
