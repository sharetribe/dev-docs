...
description: This guide describes how to use extended data to expand the user data model in Sharetribe Web Template.
---
...
page, you will need to set `displayInSignup` as `false`.
...
schema type `enum`, `long`, or `boolean`, you can hide the attribute
