...
description: In this how-to guide we'll take a look at the process of setting up Google login for your marketplace. It will allow your users to sign and log in by using their Google accounts.
---
...
- **Configure Sharetribe Web Template** A few attributes from the
  ...
  <Callout>
    ...
    Google login is enabled, take a look at our [legacy
