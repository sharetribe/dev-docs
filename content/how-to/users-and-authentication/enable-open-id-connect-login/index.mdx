...
description: In this guide we'll take at how to use an OpenID Connect login solution with a Sharetribe marketplace.
---
...
Add your provider and Sharetribe SSO client credentials to `.env`. Update
...
Add buttons for your service in the
...
to parse provider response parameters, extract the ID token, and pass it to `done`. This ensures tokens flow correctly to Sharetribe’s
