...
{<h3>Update passport strategy</h3>}
...
and
[createWithIdp.js](https://github.com/sharetribe/web-template/blob/main/server/api/auth/createUserWithIdp.js#L17-L21).
Also update the
[identity provider selection logic](https://github.com/sharetribe/web-template/blob/main/server/api/auth/createUserWithIdp.js#L79-L80).

{<h3>Define a callback</h3>}
...
{<h3>Implement verify callback</h3>}
...
Auth0 requires identity provider URL with a trailing slash, unlike many
other identity providers. If you are having trouble with your Auth0 SSO
integration, make sure you have added the URL with a trailing slash. If
your URL is missing a trailing slash, you can reach out to Sharetribe
