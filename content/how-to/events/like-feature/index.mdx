  ...
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="containers" defaultOpen>
      <FileTree.Folder name="ListingPage" defaultOpen>
        <FileTree.File name="SectionLikes.js" active />
        <FileTree.File name="ListingPageCarousel.js" />
        <FileTree.File name="ListingPage.module.css" />
      </FileTree.Folder>
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
```jsx filename="ListingPageCarousel.js"
const sectionLikes = (
  <SectionLikes publicData={currentListing?.attributes?.publicData} />
);
```
  ...
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="components" defaultOpen>
      <FileTree.Folder name="OrderPanel" defaultOpen>
        <FileTree.File name="OrderPanel.js" active />
      </FileTree.Folder>
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
Add a thunk that adds the listing ID to the user extended data.
