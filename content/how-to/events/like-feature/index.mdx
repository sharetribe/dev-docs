...
sidebarTitle: Implement a like feature
description: Following this guide, you'll be able to build a feature that allows
...
### Create an instance of the component into a variable
...
### Import updateLikes to ListingPage.js
...
### Initialise new props in ListingPage component
...
### Connect updateLikes to mapDispatchToProps function on ListingPage.js
...
### Pass _SectionHeading_ the correct props in _ListingPage.js_
...
### Define props in _SectionLikes.js_
...
### Define currentLikes in _SectionLikes.js_
...
### Filter events by _user/updated_
...
events, you can read
[our articles on reacting to events](/how-to/events/reacting-to-events/) and
