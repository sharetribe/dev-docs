...
sidebarTitle: View events with Sharetribe CLI
description: This guide shows you how to query and view events data using
...
The Sharetribe CLI (Command-line interface) is a tool for examing and
...
- [Reacting to events](/how-to/events/reacting-to-events/) how-to guide guide
