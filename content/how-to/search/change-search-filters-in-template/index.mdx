...
sidebarTitle: Change search filters
description: This guide describes how to change the search filters in Sharetribe
  Web Template.
---
...
the related [concepts article](/concepts/listings/how-the-listing-search-works/).
...
[listing extended data concepts article](/concepts/extended-data/listing-extended-data/)
and the
[Extend listing data in Sharetribe Web Template](/how-to/listings/extend-listing-data-in-template/)
how-to guide.
