...
sidebarTitle: Set up outgoing email settings
description:
...
<br />
<Cards.Card
  title="Learn how to configure your outgoing email address"
  href="https://www.sharetribe.com/help/en/articles/8704439-how-to-configure-your-outgoing-email-address"
  arrow
/>
...
## Changing from own to managed account

Please contact our [support](mailto:hello@sharetribe.com) to switch from
using your own SendGrid key back to managed email sending.
