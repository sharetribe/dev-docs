...
sidebarTitle: Add listings with multiple seats
description: This guide describes how to handle multiple seats in listings and bookings in earlier template versions
---
...
- For enabling seats in the default plan, we will update
  `AvailabilityPlanEntries.js`, which is a subcomponent used in
...
- For showing those changes, we will update in `WeeklyCalendar.js`
    ...
    <FileTree.Folder name="containers" defaultOpen>
      <FileTree.Folder name="EditListingPage" defaultOpen>
        <FileTree.Folder name="EditListingWizard" defaultOpen>
          <FileTree.Folder name="EditListingAvailabilityPanel" defaultOpen>
            <FileTree.Folder name="EditListingAvailabilityExceptionForm">
              <FileTree.File name="EditListingAvailabilityExceptionForm.js" />
              <FileTree.File name="EditListingAvailabilityExceptionForm.module.css" />
            </FileTree.Folder>
            <FileTree.Folder name="EditListingAvailabilityPlanForm">
              <FileTree.File name="AvailabilityPlanEntries.js" />
            </FileTree.Folder>
            <FileTree.Folder name="WeeklyCalendar">
              <FileTree.File name="WeeklyCalendar.js" />
            </FileTree.Folder>
            <FileTree.File name="EditListingAvailabilityPanel.js" />
          </FileTree.Folder>
        </FileTree.Folder>
      </FileTree.Folder>
    </FileTree.Folder>
...
<details>
  <summary>Click here to see how to add seats for hourly availability</summary>
...
1. Add a numeric `FieldTextInput` to the `TimeRangeSelects` component:
...
When the listing authors clicks "Save schedule" on the default availability
plan modal, `EditListingAvailabilityPanel` creates availability plan
...
<details>
  <summary>Click here to see how to show seats for hourly availability</summary>

If you are working with hourly bookings, you can do the following
instead of modifying the `availabilityInfo` message:

1. Pass the `entry.seats` value as a new prop from
   `WeeklyCalendar.PlanEntry` to `TimeRange`
...
2. In `TimeRange`, get the `seats` value from props.
...
3. Show the `seats` prop in the `span` elements with
   `className={css.dateSection}` in `TimeRange`, e.g.
...
always be created with 0 seats. Listing authors can then add availability
...
const saveException = (values) => {
  const { availability, exceptionStartTime, exceptionEndTime, exceptionRange } =
    values;
  ...
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="components" defaultOpen>
      <FileTree.Folder name="OrderPanel" defaultOpen>
        <FileTree.Folder name="BookingDatesForm">
          <FileTree.File name="BookingDatesForm.js" />
        </FileTree.Folder>
      </FileTree.Folder>
    </FileTree.Folder>
  </FileTree.Folder>
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="components" defaultOpen>
      <FileTree.Folder name="FieldDateRangeInput">
        <FileTree.File name="FieldDateRangeInput.js" />
      </FileTree.Folder>
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
Next, add the `seatsArray` and `seatsLabel` props to the render function
destructuring:
...
We only want to show the seats selection if the `seatsArray` has been
...
<details>
  <summary>Click here to see how to add seat selection to hourly bookings</summary>
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="components" defaultOpen>
      <FileTree.Folder name="OrderPanel" defaultOpen>
        <FileTree.Folder name="BookingTimeForm">
          <FileTree.File name="BookingTimeForm.js" />
...
In `BookingTimeForm`, you will need to modify `handleOnChange` to pass
...
<details>
  <summary>Click here to see how to handle line items for hourly bookings</summary>
...
<br />
For this reason, we use **quantity** to denote the number of days when seats are
not defined, and **units** to denote the number of days when seats are defined.
...
Finally, we replace `quantity` in the order line item with
`quantityOrSeats`.
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="components" defaultOpen>
      <FileTree.Folder name="OrderBreakdown">
        <FileTree.File name="LineItemBasePriceMaybe.js" />
      </FileTree.Folder>
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="containers">
      <FileTree.File name="ListingPage.shared.js" />
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="containers" defaultOpen>
      <FileTree.Folder name="CheckoutPage">
        <FileTree.File name="CheckoutPageWithPayment.js" />
      </FileTree.Folder>
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
- Allow adding seats to a listing
  - Update default availability plan handling in
    `EditListingAvailabilityPanel.js` and `AvailabilityPlanEntries.js`
...
- Allow bookings with multiple seats
  - Add seats handling to `ListingPage.shared.js`, `CheckoutPage.js` and
