...
description: This guide describes how to customize Sharetribe Web Template to use a new transaction process.
---
...
[this article](/template/configuration/hosted-and-local-configurations/) to modify the
...
`...stateDataBooking.js`) export a `getStateDataFor...` function,
...
uniquely named `getStateDataFor...` function from that file.
