---
title: Edit an existing transaction process with Sharetribe CLI
sidebarTitle: Edit a transaction process
description:
  This guide shows you how to edit an existing transaction process with
  Sharetribe CLI. You will learn how to pull the process definition,
  make a small change to it, and push the change.
---
