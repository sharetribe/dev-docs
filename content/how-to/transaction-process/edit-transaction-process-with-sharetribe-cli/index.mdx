...
sidebarTitle: Edit the transaction process
description: This tutorial shows you how to edit transaction process with Sharetribe CLI. You will learn how to pull process definition, make a small change to it and push the change.
---
