...
sidebarTitle: Integrate 3rd-Party Gateway
description: This guide describes, on a high-level, how to integrate any 3rd-party payment gateway with your Sharetribe-powered marketplace.
---
...
Use hosted pages for onboarding if they are
...
Use **events** for this step. Poll the
...
[academy-payment-service-providers]: https://www.sharetribe.com/academy/marketplace-payments/
...
[adyen-platforms-get-started]: https://docs.adyen.com/platforms/get-started/
...
[dev-docs-concepts-privileged-transitions]: /concepts/transactions/privileged-transitions/
...
[web-template-api-router]: https://github.com/sharetribe/web-template/blob/main/server/apiRouter.js
[template-initiate-privileged]: https://github.com/sharetribe/web-template/blob/main/server/api/initiate-privileged.js
