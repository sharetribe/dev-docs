...
description: An overview of the Sharetribe Web Template functionality for storing payment cards.
---
...
```js
stripe.confirmCardPayment(stripePaymentIntentClientSecret, paymentParams);
```
