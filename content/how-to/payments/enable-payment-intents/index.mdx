...
sidebarTitle: Enable PaymentIntents
description: Overview of how Stripe PaymentIntents work in Sharetribe Web Template, and how you can update legacy templates and custom apps to support Strong Customer Authentication (SCA).
---
...
use in your custom client application.
...
[the concepts article on payment methods](/concepts/payments/payment-methods-overview/)
and [payment intents](/concepts/payments/payment-intents/) for more information.
...
[live environment](/template/hosting/how-to-deploy-template-to-production/)
