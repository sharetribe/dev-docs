...
sidebarTitle: Transaction process time expressions
description: This reference article describes the time expressions used in the transaction process.
---
...
| `:time/booking-display-end`   | -                           | The booking display end timestamp.                                                                                                                     | `{:fn/timepoint [:time/booking-end]}`                                    |     | `{:fn/timepoint [:time/booking-end]}` |
