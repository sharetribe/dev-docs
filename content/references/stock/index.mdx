...
sidebarTitle: Listing stock management
...
your [transaction process](/concepts/transactions/transaction-process/). An
...
[transaction transition](/concepts/transactions/transaction-process/) failed to
