---
title: Extended data
sidebarTitle: Extended data
description: Reference documentation providing information on all the different types of extended data.
---
...
<Callout type="important">
  Extended data support in API resources is work in progress. See the [API
  reference](/concepts/api/) for each resource for information on supported
  extended data.
</Callout>
...
searching via
`/listings/query` in Marketplace API,
`/listings/query` in Integration API
or
`/users/query` in Integration API.
