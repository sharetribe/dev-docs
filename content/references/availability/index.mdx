...
sidebarTitle: Availability management
description: Reference documentation for listing availability management.
---
...
[transaction process](/concepts/transactions/transaction-process/). The transaction
