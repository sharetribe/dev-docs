---
title: Routing
description: This article explains how routing works in the Sharetribe Web Template
---
...
- Dispatch location changed actions to Redux store. This makes it
  ...
  [Enable analytics](/template/analytics/how-to-set-up-analytics-for-template/)
  guide.
...
Read more about [code-splitting](/template/routing/code-splitting-in-template/).
...
```js
dataLoader.loadData(req.url, sdk /* other params */).then((preloadedState) => {
