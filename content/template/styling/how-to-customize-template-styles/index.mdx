...
--colorSuccessLight: #1aad57;
--colorSuccessSubtle: #f0fff6;
--colorFail: #e7000b;
--colorFailDark: #cc0000;
...
providing variables for box-shadows, border-radii, transitions, and so
on. Our current plan is to parameterize styling even more using this
concept.
