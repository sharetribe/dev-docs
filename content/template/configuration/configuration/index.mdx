...
description: The Sharetribe Web Template has many configurations you can edit
...
in the [template environment variables](/template/configuration/template-env/)
article.
...
data fields. [Extended data](/concepts/extended-data/extended-data-introduction/)
...
settings. See [this article](/template/maps/configure-maps/) for a complete
...
the how to set up
[Google Maps](/template/maps/how-to-use-google-maps-in-template/) or
[Mapbox](/template/maps/how-to-set-up-mapbox-for-template/) article.
