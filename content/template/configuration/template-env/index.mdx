...
- **`REACT_APP_GOOGLE_MAPS_API_KEY`**
  ...
  See the
  [How to use Google Maps](/template/maps/how-to-use-google-maps-in-template/)
  guide for more information.
...
* **`REACT_APP_FACEBOOK_APP_ID`**
  ...
  does not yet enable the feature. See [how to enable Facebook login](/how-to/users-and-authentication/enable-facebook-login/).
...
* **`REACT_APP_GOOGLE_CLIENT_ID`**
  ...
  The Client ID of your Google Sing-In. Corresponds to client ID of
  the identity provider client in Console. Adding this key does not
  yet enable the feature. See [how to enable Google login](/how-to/users-and-authentication/enable-google-login//).
