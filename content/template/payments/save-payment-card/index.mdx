...
sidebarTitle: Saving a Payment Card
description:
...
payment first and then they are able to replace the default card.
...
article about
**[enabling payment intents](/how-to/payments/enable-payment-intents/)**.
...
[`fetchCurrentUser` in CheckoutPage.duck.js](https://github.com/sharetribe/web-template/blob/main/src/containers/CheckoutPage/CheckoutPage.duck.js#L409).
...
Parameters might be different in different transaction process graphs.

</Callout>

See the
[`initiateOrderThunk` function](https://github.com/sharetribe/web-template/blob/main/src/containers/CheckoutPage/CheckoutPage.duck.js#L96)
and related
[`orderParams`](https://github.com/sharetribe/web-template/blob/main/src/containers/CheckoutPage/CheckoutPageWithPayment.js#L138)
...
**[`confirmCardPayment` thunk function](https://github.com/sharetribe/web-template/blob/main/src/ducks/stripe.duck.js#L59)**.

</Callout>

Stripe's frontend script checks if PaymentIntent needs extra actions
...
[`confirmPayment` thunk call](https://github.com/sharetribe/web-template/blob/main/src/containers/CheckoutPage/CheckoutPage.duck.js#L122)
...
has selected one-time payment - instead of making a charge from the
previously saved credit card.

In the template, we call
[savePaymentMethod function](https://github.com/sharetribe/web-template/blob/main/src/ducks/paymentMethods.duck.js#L100)
...
Template:
[`dispatch(createStripeCustomer(stripePaymentMethodId))`](https://github.com/sharetribe/web-template/blob/main/src/ducks/paymentMethods.duck.js#L110)
...
Template:
[`dispatch(updatePaymentMethod(stripePaymentMethodId))`](https://github.com/sharetribe/web-template/blob/main/src/ducks/paymentMethods.duck.js#L112)
...
Template:
[`dispatch(addPaymentMethod(stripePaymentMethodId))`](https://github.com/sharetribe/web-template/blob/main/src/ducks/paymentMethods.duck.js#L113)
