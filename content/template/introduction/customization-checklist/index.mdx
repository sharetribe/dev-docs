...
[marketplace texts](/concepts/content-management/marketplace-texts/) to
reflect your brand and messaging. There are several places where you can
edit the content and copy texts in your marketplace:

- Learn about
  [marketplace texts](/concepts/content-management/marketplace-texts/)
- Update your
...
- Update the
  [email templates](/concepts/messages-notifications/email-notifications/):
...
- Add more content pages:
  [How the templates render content pages using the PageBuilder](/template/content-management/page-builder/)
