...
description: This guide describes how to enable analytics in the Sharetribe Web
  Template
---
...
<video controls>
  <source
    src="/resources/videos/turn-off-enhanced-measurements.mp4"
    type="video/mp4"
  />
  <source
    src="/resources/videos/turn-off-enhanced-measurements.webm"
    type="video/webm"
  />
  <source
    src="/resources/videos/turn-off-enhanced-measurements.ogv"
    type="video/ogg"
  />
</video>
