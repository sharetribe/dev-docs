...
description: This guide describes how to deploy the Sharetribe Web Template to
  Heroku.
---
...
{<h3>Change the environment variables</h3>}
...
{<h3>Connect the Heroku app to Github</h3>}
