...
<Callout>
  ...
  Sharetribe Console before you can connect your custom application to your Live
  environment.
</Callout>
...
[environment variables](/template/configuration/template-env/). The configuration in
Console only works for Sharetribe hosted marketplaces.

See [here how to enable Google Login](/how-to/users-and-authentication/enable-google-login/) and
[Facebook login](/how-to/users-and-authentication/enable-facebook-login/) for self-hosted
marketplaces.

</Callout>

For a full list of possible environment variables, see the
[Environment configuration variables](/template/configuration/template-env/) reference
