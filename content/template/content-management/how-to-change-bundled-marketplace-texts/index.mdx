...
description: This guide describes what bundled marketplace texts are, and how to
...
[Changing the language](/template/content-management/how-to-change-template-language/)
article.
...
- [Marketplace texts in Sharetribe](/concepts/content-management/marketplace-texts/)
- [How hosted marketpalace texts work in the template](/template/content-management/hosted-marketplace-texts/)
...
```jsx
<FormattedMessage id="BookingBreakdown.description" values={{ mode: "day" }} />
```
