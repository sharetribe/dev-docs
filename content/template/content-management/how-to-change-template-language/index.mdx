...
1. Comment out, or remove, the `messagesInLocale` definition in the
   [Template file src/app.js](https://github.com/sharetribe/web-template/blob/e014ddc6834a2cf1c46a514458f26656c3ce9882/src/app.js).
...
3. If you are using a locale not currently supported in Console while
   working with moment library, you can modify
   [app.js](https://github.com/sharetribe/web-template/blob/main/src/app.js)
   to either:
   - Add you preferred locale to MomentLocaleLoader
   - Stop using the MomentLocaleLoader and instead import the locale
     directly in `app.js`, e.g.
