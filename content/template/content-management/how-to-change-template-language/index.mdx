...
3.  Point `messagesInLocale` to correct .json file, for example:
...
Dates are formatted using your marketplace's `locale` and
`firstDayOfWeek`
[configuration variables](/template/configuration/variables/#locale). No
additional setup is needed to get correctly localized dates.
