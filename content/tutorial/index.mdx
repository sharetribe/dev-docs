---
title: Tutorial
description: Over the course of the tutorial, you will learn how to build a
...
{<h3>Check your remote repositories</h3>}
...
{<h3>Rename your repository</h3>}

Rename the Sharetribe Web Template repository (current '_origin_') as
'_upstream_'
...
Add your newly created repository as '_origin_':
