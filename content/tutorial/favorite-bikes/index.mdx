...
description: Learn how to add a favorites functionality to Sharetribe Web Template
---
...
Next, we call this function from _ListingPageCarousel.js_. We will first import the function we just created.
...
```jsx
export const queryFavoriteListings =
  (queryParams) => (dispatch, getState, sdk) => {
