...
Next, we want to pass initial values for _price_ and _helmetFee_. For
...
[Add a new line item for the helmet rental fee](/tutorial/customize-pricing/#add-a-new-line-item-for-the-helmet-fee).
...
[pricing concepts article](/concepts/pricing-and-commissions/pricing/).
...
[privileged transitions concepts article](/concepts/transactions/privileged-transitions/).
...
When a user clicks "Request to book", the listing page sends the booking
...
<details> 
<summary>Add helmet rental fee to email notifications</summary>
...
+             <td>
+               <td>
+                 <p style="font-size:16px;line-height:1.4;margin:16px 0;
+                          color:#484848;margin-top:1px">Helmet rental fee</p>
+               </td>
+               <td style="text-align:right">
+                 <p style="font-size:16px;line-height:1.4;margin:16px 0;
+                          color:#484848;margin-top:1px">
