...
description: Learn how to add a new tab to the listing creation wizard.
---
...
<details>
<summary>Add .example.js and .test.js files</summary>
...
<details> 
<summary>EditListingExtraFeaturesPanel.js explained</summary>
...
<details> 
<summary>EditListingExtraFeaturesForm.js explained</summary>
...
- import it in the _EditListingWizardTab_ componen
  t
