...
navigate to the
[_templates_ directory](/how-to/emails-and-notifications/edit-email-templates-with-sharetribe-cli/#templates-directory).
...
<details>
<summary>Add new text sections in the email template</summary>
