...
sidebarTitle: Requiring approval for new listings
description: Sharetribe allows you to require operator approval for new listings
...
[Integration API](./pintroduction/getting-started-with-integration-api/)
