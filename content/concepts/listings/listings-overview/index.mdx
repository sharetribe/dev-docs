...
If the marketplace
[requires listing approval for new listings](/concepts/listings/requiring-approval/),
...
[keywords, origin,](/concepts/listings/how-the-listing-search-works/) bounds,
...
[transaction processes](/concepts/transactions/transaction-process/), whose
