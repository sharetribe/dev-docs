...
<Callout type="info">
  Protected files as part of the transaction process are attached
  differently - the transition action
  [`:action/update-protected-files`](/references/transaction-process-actions/#actionupdate-protected-files)
  replaces the transaction's protected files with a given set. See
  [Files in Sharetribe](/concepts/files/files-in-sharetribe/#visibility)
  for details.
</Callout>
