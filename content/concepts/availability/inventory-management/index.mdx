...
description: Inventory or stock management is a key feature of many product marketplaces. Here's how the Sharetribe stock management works.
---
...
tied to [booking availability management](/concepts/availability/manage-seats/).
