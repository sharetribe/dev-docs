...
description: Sharetribe Applications are the entities that authenticate to and access the Sharetribe APIs.
---
...
[authenticate](/concepts/api-sdk/authentication-api/) your application to the
Sharetribe APIs.
