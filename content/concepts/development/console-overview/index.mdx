...
sidebarTitle: Understanding Console
description: This article will help you understand how to navigate Console.
---
...
section. You can
[read more about extended data](/concepts/extended-data/extended-data-introduction/).
...
[environment variable](/template/configuration/template-env/),
...
[modify your marketplace and email texts](/concepts/content-management/marketplace-texts/),
create [content pages](/concepts/content-management/headless-content-management/), and
...
[transaction processes in Sharetribe](/concepts/transactions/transaction-process/).
