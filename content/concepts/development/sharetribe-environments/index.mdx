...
![Environment selection](./env-change.png)
...
If you prefer a workflow where you want to copy assets directly from Dev
to Live without going through Test, contact the Sharetribe support team
