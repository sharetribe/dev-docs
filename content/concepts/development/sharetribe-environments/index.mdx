...
description: What are Sharetribe environments and the differences the three types have.
---
...
[test credit cards with Stripe](/how-to/payments/set-up-and-use-stripe/).
