...
You can use [extended data](/concepts/extended-data/extended-data-introduction/) to
...
use [social logins](/concepts/users-and-authentication/social-logins-and-sso/) to sign up, or to
...
request. If you use the [Javascript SDKs](/concepts/api-sdk/js-sdk/) in your
...
[privileged transitions](/concepts/transactions/privileged-transitions/). Privileged
actions include
