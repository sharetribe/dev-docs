---
title: Login as user
sidebarTitle: Login as user
description: This article provides guidance on how to use the "Login as User" feature. This functionality allows an operator to log into their marketplace as one of the marketplace users.
---
