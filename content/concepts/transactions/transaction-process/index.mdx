...
At the moment, it is possible to create new transaction processes and
edit existing transaction processes by creating new versions of an
existing process. Deleting transaction processes and transaction process
