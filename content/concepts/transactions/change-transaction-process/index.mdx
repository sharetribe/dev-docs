...
offered [here](/concepts/transactions/transaction-process/) by
...
[consult our guide](/introduction/design-files/) on defining the
discovery and listing creating process in your marketplace. You can see
the default user experience provided by the
[Sharetribe Web Template](/template/introduction/sharetribe-web-template/)
there too.
...
using a tool like
[Whimsical](/concepts/transactions/change-transaction-process/#start-designing).
...
You can use the [design files](/introduction/design-files/) to guide
...
article to
[review the screens that are part of a transaction](/introduction/design-files/#transaction-process).
