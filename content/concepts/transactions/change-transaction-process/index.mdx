...
description: How to create and communicate a new transaction processes or make
...
offered [here](/concepts/transactions/transaction-process/) by suggesting a few
...
[consult our guide](/introduction/design-files/) on defining
the discovery and listing creating process in your marketplace. You can
see the default user experience provided by the
[Sharetribe Web Template](/template/introduction/sharetribe-web-template/) there too.
