...
sidebarTitle: Strong Customer Authentication
description: This article gives an overview of Strong Customer Authentication, a
...
The default [transaction process](/concepts/transactions/transaction-process/) of
Sharetribe and the
...
[legacy template](https://www.sharetribe.com/docs/template/legacy/legacy-templates/)
without this feature, you will also need to update your checkout user
interface.
[Learn more about how to take SCA and Payment Intents into use](/how-to/payments/enable-payment-intents/).
