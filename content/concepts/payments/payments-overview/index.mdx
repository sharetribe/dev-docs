...
<details>
  ...
  If the presentment currency differs from the settlement currency,
  Stripe converts the charge to the settlement currency.
  <br />
  <br />
  See{' '}
...
- Double check that you have followed the
  [Stripe setup instructions](/how-to/payments/set-up-and-use-stripe/).
