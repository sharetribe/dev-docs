...
description: This article gives you a brief overview on how the Sharetribe
...
[Learn how storing payment card works in Sharetribe Web Template](/how-to/payments/save-payment-card/)
...
happen only a bit before the event, or even after it. \
 \
It's possible for you to adjust your [transaction process](/concepts/transactions/transaction-process/)
