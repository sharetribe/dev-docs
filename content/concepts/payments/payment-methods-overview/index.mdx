...
description: This article provides an overview of different payment methods in
  Sharetribe.
---
...
[the transaction process](/concepts/transactions/transaction-process/) describes the
