...
sidebarTitle: Marketplace texts
description: This article introduces marketplace texts in Sharetribe and how they are modified and edited in Sharetribe Console
---
...
```handlebars
<p
  style="font-size:16px;line-height:1.4;margin:16px 0;color:#484848;margin-bottom:1px"
>
  {{t
