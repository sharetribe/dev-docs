...
sidebarTitle: Using Console and the API to manage Pages
description: This article explains how data can be edited through Console and how it can be queried using the Asset Delivery API.
---
...
template renders content pages [here](/template/content-management/page-builder/).
