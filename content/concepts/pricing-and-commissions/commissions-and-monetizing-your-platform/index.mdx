...
[privileged transitions](/concepts/transactions/privileged-transitions/) gives you a
good understanding of the concepts discussed in this article. In
addition, the article that describes
[payments in Sharetribe](/concepts/payments/payments-overview/) provides valuable
...
<details>
<summary>Negative or positive commission?</summary>
