...
![Line items for longer checkout in Console](./longer-checkout-lineitems.png)
...
![Line items with tax](./tax-line-items.png)
...
![Line items for additional guests at a lowered price](./additional-guests-line-items.png)
