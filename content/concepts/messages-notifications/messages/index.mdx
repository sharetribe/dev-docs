...
[built-in email notification](/concepts/messages/email-notifications/)
...
<video controls>
  <source src="/resources/videos/zapier.mp4" type="video/mp4" />
  <source src="/resources/videos/zapier.webm" type="video/webm" />
  <source src="/resources/videos/zapier.ogv" type="video/ogg" />
</video>
...
1.  The template
    [makes two queries](https://github.com/sharetribe/web-template/blob/main/src/ducks/user.duck.js#L311-L328)
    that retrieve all sales transactions (i.e. transactions where the
...
2.  The number of relevant sales and order transactions determines the
    [notification count](https://github.com/sharetribe/web-template/blob/main/src/containers/TopbarContainer/TopbarContainer.js#L55)
...
[events](/how-to/events/reacting-to-events/).
