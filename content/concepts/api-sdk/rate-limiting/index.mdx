...
description: This article describes rate limiting in Marketplace API and Integration API, as well as suggests how to handle those limits gracefully.
---
...
<details>
  <summary>What are rate limits and concurrency limits?</summary>
