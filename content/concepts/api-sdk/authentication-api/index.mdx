...
description: Description of the Sharetribe Authentication API and how the Marketplace API and Integration API applications use it
---
...
[Applications](/concepts/development/applications/) obtain those access tokens from
...
Integration API is to use our [SDKs](/concepts/api-sdk/js-sdk/). The SDKs handle
...
- `token_exchange` grant type is used by Marketplace API to create a
  ...
  [privileged transitions](/concepts/transactions/privileged-transitions/) within
