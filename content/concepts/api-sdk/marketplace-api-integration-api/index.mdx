---
title: Marketplace API and Integration API
sidebarTitle: Marketplace API & Integration API
description: Description of the different Sharetribe APIs and how to choose which one to use
---
...
Never expose your Integration API [application](/concepts/development/applications/)
