...
description: Sharetribe allows your users to communicate with each other using
...
[built-in email notification](/concepts/messages/email-notifications/) sent to
...
a new message is detected using [events](/how-to/events/reacting-to-events/).
