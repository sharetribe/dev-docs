...
description: Transaction extended data allows you to keep sensitive information stored and visible for both transaction parties, as well as add information related to, for example, integrations or analytics.
---
...
[listen to transaction events](/how-to/events/reacting-to-events/) and update
