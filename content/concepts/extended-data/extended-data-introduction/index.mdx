...
description: Extended data allows you to fully customize the information you want to collect about users, listings, and transactions on your marketplace.
---
...
We have highlighted the fields in different colors: blue is for tire size, and green is for bike brand.

![An image highlighting the extended data attributes in the client application](./extended-data-frontend-view.png)
...
![An image of the client app editing the details of a listing](./extended-data-details.png)
...
![An image from Console showing the extended data attributes](./extended-data-console-view.png)
