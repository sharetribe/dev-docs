 ...
 * Logo
 *
 * A responsive SVG logo that adapts to light/dark themes.
 * The brand mark remains constant,
 * while the text color changes based on theme.
 */
const Logo = (props) => {
  return (
    <svg
